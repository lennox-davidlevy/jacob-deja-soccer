...
Premiere is where you touch the clip first. You know Photoshop; Premiere's model: a **Project panel**
(your media library), a **Timeline** (clips arranged in time), a **Program monitor** (playback). Space =
play. J/K/L = shuttle.
