...
2. **THE SCRUB** — full-viewport pinned stage, staged as a **diorama**: every subject (Jacob, defender,
   ball, net) is an isolated cut-out actor on the void; scroll is time; the attack always travels left →
   right; scrolling up rewinds everything (the ball returns to his foot). Five acts:
   approach (subjects small, entering left, fast scrub) → slow-mo spin (**scale-jump to large, center
   stage, slowest scrub — the centerpiece**; the volt trail wraps the ball's arc, and the beaten defender
   **drifts out of the floodlight and dissolves into the void**) → strike (thin volt rim + small bloom,
   ≤5% accent) → **THE BALL: POV reversal — the viewer is the goal.** The roto'd net stretches across the
   whole viewport as a faint volt-tinted foreground scrim; the ball grows from far to huge at the lens and
   **match-cuts**: a volt circle expands from it to fill the screen and resolves into a **TITLE CARD** —
   JACOB DEJA + ball motif — over the **celebration footage as a muted, graded, low-opacity loop**. The
   subtext for the coach at the match cut: *you just got scored on.* The title card releases into →
...
Hi-fi mockups, **mobile (390px) and desktop (1440px)**, of: hero, scrub stage (five moments: approach /
spin / strike flash (rim only) / ball-at-camera mid-match-cut / TITLE CARD over the celebration loop),
vitals, film, schedule, about, contact — plus the one-pager PDF.
